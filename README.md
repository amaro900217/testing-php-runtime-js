...
- Explore shared workers and keepalive iframe...
...
- Merge warmup worker for snapshot into installation worker or remove snapshot worker, check it, it may be overhead
