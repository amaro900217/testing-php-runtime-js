...
[Primary Worker: Install WASM + PHP Project]
       │
       ▼
[Warmup Worker: Initialize a Worker and saves snapshot for future use]
       │
       ▼
...
- Review worker snapshot -> ?? HEAVY TESTING to check if persistence like creating files or writing in DB is affected!!
- Merge warmup worker for snapshot into installation worker...
